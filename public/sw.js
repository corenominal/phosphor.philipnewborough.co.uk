...
const CACHE_NAME = 'phosphor-v1.28';

// ─── Assets to pre-cache on install ───────────────────────────────────────────
const ASSETS = [
    '/',
    '/index.html?v=1776463803932',
    '/manifest.json',
    '/css/style.css?v=1776463803932',
    '/js/settings.js?v=1776463803932',
    '/js/crypto.js?v=1776463803932',
    '/js/entropy.js?v=1776463803932',
