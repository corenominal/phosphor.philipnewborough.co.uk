...
const CACHE_NAME = 'phosphor-v1.27';

// ─── Assets to pre-cache on install ───────────────────────────────────────────
const ASSETS = [
    '/',
    '/index.html?v=1775720904572',
    '/manifest.json',
    '/css/style.css?v=1775720904572',
    '/js/settings.js?v=1775720904572',
    '/js/crypto.js?v=1775720904572',
    '/js/entropy.js?v=1775720904572',
