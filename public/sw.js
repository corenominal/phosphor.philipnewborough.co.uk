...
const CACHE_NAME = 'phosphor-v1.14';

// ─── Assets to pre-cache on install ───────────────────────────────────────────
const ASSETS = [
    '/',
    '/index.html?v=1775675173815',
    '/manifest.json',
    '/css/style.css?v=1775675173815',
    '/js/settings.js?v=1775675173815',
    '/js/crypto.js?v=1775675173815',
    '/js/entropy.js?v=1775675173815',
