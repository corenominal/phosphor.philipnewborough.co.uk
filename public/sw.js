...
const CACHE_NAME = 'phosphor-v1.24';

// ─── Assets to pre-cache on install ───────────────────────────────────────────
const ASSETS = [
    '/',
    '/index.html?v=1775719235703',
    '/manifest.json',
    '/css/style.css?v=1775719235703',
    '/js/settings.js?v=1775719235703',
    '/js/crypto.js?v=1775719235703',
    '/js/entropy.js?v=1775719235703',
