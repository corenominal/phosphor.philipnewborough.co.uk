...
const CACHE_NAME = 'phosphor-v1.9';

// ─── Assets to pre-cache on install ───────────────────────────────────────────
const ASSETS = [
    '/',
    '/index.html?v=1775663217098',
    '/manifest.json',
    '/css/style.css?v=1775663217098',
    '/js/settings.js?v=1775663217098',
    '/js/crypto.js?v=1775663217098',
    '/js/entropy.js?v=1775663217098',
