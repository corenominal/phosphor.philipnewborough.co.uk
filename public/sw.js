...
const CACHE_NAME = 'phosphor-v1.10';

// ─── Assets to pre-cache on install ───────────────────────────────────────────
const ASSETS = [
    '/',
    '/index.html?v=1775674129875',
    '/manifest.json',
    '/css/style.css?v=1775674129875',
    '/js/settings.js?v=1775674129875',
    '/js/crypto.js?v=1775674129875',
    '/js/entropy.js?v=1775674129875',
